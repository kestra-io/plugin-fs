...
class MoveTest {
    ...
    void setUp() throws IOException {
        Path tempDir = Files.createTempDirectory(Path.of(USER_DIR), "kestra-test-move-");
    ...
    void moveFile() throws Exception {
        ...
        Move.Output output = task.run(TestsUtils.mockRunContext(runContextFactory, task, Map.of()));
